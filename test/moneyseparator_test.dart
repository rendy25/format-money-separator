...
import 'package:moneyseparator/moneyseparator.dart';
...
void main() async {
  ...
  test('deleting zero works', () {
    var res = MoneyFormatter().formatEditUpdate(
  ...
  test('works with i18n', () {
    var text = MoneyFormatter(decimalSeparator: ',');
